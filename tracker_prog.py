...
def tk_gui():
    ...
    btn_1 = tk.Button(master = fr, text = "Longitude/Latitude Plot", command = long_lat_track)
...
def main():
    ...
    if len(args) < 1:
        print("Incorrect usage: Input Keyword args... 'long-lat', 'map', 'freqs', 'times', 'mean-speed', or 'gui'")
        sys.exit(1)
